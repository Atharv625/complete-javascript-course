...
// console.log(Math.max(5,8,6,9,5,63,2,45,8))
// console.log(Math.min(5,8,6,9,5,63,2,45,8))
...
// console.log(20n===20);
// const huge=578754875491878787n;
...
console.log(Math.abs(daysPassed(new Date(2037,10,19,15,23),new Date(2027,10,19,15,23))));
const options={
  style:'percent',
  unit:'mile-per-hour',
}
